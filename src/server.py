...
def main():
    ...
    while not rospy.is_shutdown():
        ...
        if(text_des_1 is not None):
            ...
            robot_loc1 = json_out1["coordinates"]
            obstacle1 = json_out1["possible_directions"]
            
            robot_loc1 = [int(val) for val in robot_loc1]
            obstacle1 = [int(val) for val in obstacle1]
            obstacle1 = np.asarray(obstacle1)
            
            robot_loc1[0] = robot_loc1[0] + center[0]
            robot_loc1[1] = robot_loc1[1] + center[1]
        ...
        if(text_des_2 is not None):
            ...
            robot_loc2 = json_out2["coordinates"]
            obstacle2 = json_out2["possible_directions"] 
            
            robot_loc2 = [int(val) for val in robot_loc2]
            obstacle2 = [int(val) for val in obstacle2]
            obstacle2 = np.asarray(obstacle2)
            
            robot_loc2[0] = robot_loc2[0] + center[0]
            robot_loc2[1] = robot_loc2[1] + center[1]
        ...
        static_transform_stamped.transform.translation.x = 500 *grid3.info.resolution 
        static_transform_stamped.transform.translation.y = 501 *grid3.info.resolution 
        ...
        static_transform_stamped2.transform.translation.x = 500 *grid3.info.resolution 
        static_transform_stamped2.transform.translation.y = 500 *grid3.info.resolution 
