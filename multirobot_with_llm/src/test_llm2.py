...
#### Input: {inp} ### Response:
    ...
    #             "Based on this, provide only a description of the robot’s current location and its ability to move in the clear directions(All directons). No JSON output is needed. "\
    #             "For example:" \
    ...
    #             "Input: 'robot loc: (0,0) and Lidar data: (0,0,0,0,0,0,1,0)' " \
    #             "Output: 'My current location is (0,0). I can move only in the south direction.' " \
