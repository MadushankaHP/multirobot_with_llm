...
def get_direction_coordinate(center, radius, dir,direction,robot_loc):
    ...
    # if(closest_direction=='north'):
    #     dx1 = 0
    #     dy1 = 1

    # if(closest_direction=='northeast'):
    #     dx1 = 1
    #     dy1 = 1

    # if(closest_direction=='east'):
    #     dx1 = 1
    #     dy1 = 0
    ...
    return (x + (dx1*2), y + (dy1*2)),closest_direction
...
def main():
    ...
    rospy.Subscriber('/rb1_move_dir',String, callback4);
    ...
    while not rospy.is_shutdown():
        ...
        if location is not None and direction is not None:
            ...
            if(core==True):
                ...
                print("robot 1 new loc:", robot_new_target)
                ...
                client = MoveBaseClient("jb_0")  # Replace "robot1" with your robot's name
